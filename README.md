...
Most working researchers keep their protocols in Word documents, lab notebooks, or scattered PDFs and versions can drift between people's laptops and nobody knows whose copy is canonical. Existing tools either require institutional buy-in and cloud accounts, or are built for compliance rather than the person at the bench at 11pm trying to remember what RNase A concentration they used six months ago.
